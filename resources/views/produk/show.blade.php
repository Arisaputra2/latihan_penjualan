        ...
        <div class="row">
            <div class="col-lg-6 p-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="kategori" name="id_kategori" value="{{ $produk->category->nama }}">
                  </div>
                  <div class="mb-3">
                    <label for="qty" class="form-label">Qty</label>
                    <input type="text" class="form-control" id="qty" name="qty" value="{{ $produk->qty }}">
                  </div>
                  <div class="mb-3">
                    <label for="harga_beli" class="form-label">Harga Beli</label>
                    <input type="text" class="form-control" id="harga_beli" name="id_harga_beli" value="{{ $produk->harga_beli }}">
                  </div>
                  <div class="mb-3">
